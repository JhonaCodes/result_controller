...
void main() {
  group('Advanced Error Handling Scenarios', () {
    ...
    test('Result.tryAsync handles complex asynchronous errors', () async {
      Future<Result<int, ResultError>> complexAsyncErrorResult = Result.tryAsync(() async {
    ...
    test('Result.tryAsyncMap handles complex asynchronous error transformations', () async {
      ...
      result.when(
        ...
        err: (error) {
          expect(error, matches(RegExp(r'Network Connectivity Error:|Unexpected Async Error:')));
        },
      );
    });
    ...
    test('Handling edge cases with multiple error transformation strategies', () {
